import sys,os
import PySide2
from PySide2.QtWidgets import QApplication, QMainWindow, QAction, QTextEdit, QFileDialog
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Pyside2 Print PDF")  # Configure le titre de la fenêtre
