import sys,os
import PySide2
from PySide2.QtWidgets import QApplication, QMainWindow, QColorDialog, QAction, QFontDialog, QTextEdit, QFileDialog
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Pyside2 Color Dialog")  # Configure le titre de la fenêtre
